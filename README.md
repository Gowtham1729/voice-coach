...
**[Voice Coach 3.3.0 for macOS](https://github.com/Gowtham1729/voice-coach/releases/tag/v3.3.0)** — zip, move to Applications. If Gatekeeper blocks: right-click → **Open**.
