...
public struct TranscriptionSetupService: Sendable {
    ...
    public static func currentStatus(
        ...
        guard let executable = NemoSpeechTranscriber.findExecutable(
    ...
    public func installOrUpdate(
        ...
        let workDirectory = fileManager.temporaryDirectory
            .appendingPathComponent("voice-coach-transcription-setup-\(UUID().uuidString)", isDirectory: true)
    ...
    private func runProcess(
        ...
        try await Task.detached(priority: .userInitiated) {
            ...
            guard process.terminationStatus == 0 else {
                throw mapError(Self.processFailureDetail(
                    stdoutURL: stdoutURL,
                    stderrURL: stderrURL,
