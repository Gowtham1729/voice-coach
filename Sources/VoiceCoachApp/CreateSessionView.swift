    ...
    var body: some View {
        StudioPage(maxWidth: 760, horizontalPadding: 24) {
            VStack(alignment: .leading, spacing: 18) {
                ...
                Text("Import a file, or capture Mac audio. Then select a short excerpt. Attempts stay with this reference.")
                    .font(.callout)
                ...
                HStack {
                    ...
                    .disabled(model.mimicDraft == nil || model.mimicIsPreparing || model.isCapturingMimicReference || excerptEnd - excerptStart < 1)
